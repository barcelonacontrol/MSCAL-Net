...
class Pancras(Dataset):
    def __init__(self, base_dir=None, split='train', num=None, transform=None, common_transform=None,
                 sp_transform=None):
        ...
        train_path = self._base_dir + '/flods/train0.list'
        test_path = self._base_dir + '/flods/test0.list'
        if split == 'train':
...
class pack(Dataset):
    """ LA Dataset """
    def __init__(self, base_dir=None, split='train', num=None, transform=None, common_transform=None,sp_transform=None):
        self._base_dir = base_dir
        self.transform = transform
        self.sample_list = []
        self.common_transform = common_transform
